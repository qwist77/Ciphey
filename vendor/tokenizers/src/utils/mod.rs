...
#[cfg(all(not(feature = "fancy-regex"), feature = "onig"))]
mod onig;
#[cfg(all(not(feature = "fancy-regex"), feature = "onig"))]
pub use crate::utils::onig::SysRegex;

#[cfg(not(any(feature = "fancy-regex", feature = "onig")))]
compile_error!("tokenizers requires either the `fancy-regex` or `onig` feature");
